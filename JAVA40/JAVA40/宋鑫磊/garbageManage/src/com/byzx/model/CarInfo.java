...
public class CarInfo {
	...
	private Integer c_carid; //车辆id
	private int c_number; //车牌号
	private int d_id; //司机id
	private String c_buytime; //购买时间
	private int c_capacity; //载重
	private String c_state; //状态
	private String c_location; //位置
