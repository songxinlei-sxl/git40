...
public class UserInfoController {
	...
	@RequestMapping("/findAllRecycleUserId")
	public void findAllRecycleUserId(HttpServletResponse response) throws Exception {
		JSONArray jsonArray = userInfoService.findAllRecycleUserId();
